...
Проєкт використовується як робоче рішення (**deployed**). Медіа-матеріали (фото/відео) плануються до додавання.

## Авторство

Усі частини проєкту виконані власноруч: електроніка, прошивка Arduino, Python-скрипт для парсингу та генерації таблиці світанків, інтеграція з RTC та логіка діагностики.
