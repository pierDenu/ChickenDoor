...
> Примітка: у силових навантаженнях типу соленоїда зазвичай застосовують захист від ЕРС самоіндукції (наприклад, діод). У цьому репозиторії описано фактичну конфігурацію (MOSFET + соленоїд); за потреби цей блок можна розширити конкретними схемними рішеннями.
